  ...
  <div class="container">
    ...
    $result = $db->select_to_array($sql);
      ...
      foreach ($result as $item) {
        ...
        $str = '<div class="col-lg-4 promo_col">
            <div class="promo_item">
              ...
              $str1='<div class="promo_content promo_content_2">
                   <div class="promo_title">';
                   echo html_entity_decode($str1,ENT_HTML5);
                   echo "".$item["Name"]."</div>";

                  $str2 = '<div class="promo_subtitle">';
                  echo html_entity_decode($str2,ENT_HTML5);
                  echo "".$item["Description"]."</div></div>
                </div>";

              $str3 = '<div class="promo_link"><a>Shop Now</a></div>
            </div>
          </div>';
          echo html_entity_decode($str3,ENT_HTML5);
